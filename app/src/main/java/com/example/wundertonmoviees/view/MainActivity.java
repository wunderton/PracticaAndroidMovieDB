package com.example.wundertonmoviees.view;
...
import com.example.wundertonmoviees.adapter.SearchAdapter;
import com.example.wundertonmoviees.fragments.FavouriteMovies;
import com.example.wundertonmoviees.fragments.Movies;
import com.example.wundertonmoviees.model.Discover;
import com.example.wundertonmoviees.model.DiscoverDBResponse;
import com.example.wundertonmoviees.model.GenresList;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(RetrofitInstance.getApiKey().isEmpty())
        {
       ...
       searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
           ...
           public boolean onQueryTextSubmit(String query) {
               ...
               if (!query.isEmpty()) {
                   ...
                   final MovieDataService movieDataService = RetrofitInstance.getService();
                   final String ApiKey = RetrofitInstance.getApiKey();
                   queryM = query;
                   drawer = 3;
